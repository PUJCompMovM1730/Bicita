...
public class ActivityActualizarPerfilEmpresa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actualizar_perfil_empresa);

        mAuth = FirebaseAuth.getInstance();
        database = FirebaseDatabase.getInstance();
        storageRef = FirebaseStorage.getInstance().getReference();

        nombre = (TextView) findViewById(R.id.nombreAE);
        correo= (TextView) findViewById(R.id.correoAE);
        nit=(TextView) findViewById(R.id.nitAE);

        correo.setFocusable(false);

        cam = (CircleImageView) findViewById(R.id.btnCamara_empresa);

        galeria = (Button) findViewById(R.id.btnGaleria_empresa);
        actualizar = (Button) findViewById(R.id.actualizarEmpresa);
        ...
        actualizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(user != null){
                    ...
                    database.getReference(PATH_BICIUSUARIOS + user.getUid()).child("nit").setValue(nit.getText().toString());
