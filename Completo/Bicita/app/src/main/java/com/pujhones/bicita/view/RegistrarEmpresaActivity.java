...
public class RegistrarEmpresaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nombre = (EditText)findViewById(R.id.nombreEm);
        correo = (EditText) findViewById(R.id.correoEm);
        nit = (EditText) findViewById(R.id.nitEm);
        pssw = (EditText) findViewById(R.id.psswREmpre);
        registro = (Button) findViewById(R.id.crearEmpresa);
        galeria = (Button) findViewById(R.id.btnGaleria_empresa_cre);
        cam = (CircleImageView) findViewById(R.id.btnCamara_empresa_cre);
            ...
            public void onClick(View view) {
                if (!nombre.getText().toString().equals("") &&
                    ...
                    mAuth.createUserWithEmailAndPassword(correo.getText().toString(), pssw.getText().toString())
                            .addOnCompleteListener(RegistrarEmpresaActivity.this, new OnCompleteListener<AuthResult>() {
                                @Override
                                        ...
                                        if (user != null) {
                                            ...
                                            uploadTask.addOnFailureListener(new OnFailureListener() {
                                                ...
                                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                                    ...
                                                    Log.i(TAG, fullURL);
                                                    //(String uid, String nombre, String nit, String correo, String photoURL)
                                                    BiciEmpresa bu = new BiciEmpresa(
                                                    ...
                                                    Toast.makeText(RegistrarEmpresaActivity.this, "Registro exitoso", Toast.LENGTH_SHORT).show();
                                                    startActivity(new Intent(RegistrarEmpresaActivity.this, ActivityPerfilEmpresa.class));
                                                }
                                            });
                                        }
                                    }
                                    if (!task.isSuccessful()) {
                                        Toast.makeText(RegistrarEmpresaActivity.this, R.string.auth_failed + task.getException().toString(), Toast.LENGTH_SHORT).show();
                    ...
                    if (!android.util.Patterns.EMAIL_ADDRESS.matcher(correo.getText().toString()).matches()) {
                        Toast.makeText(RegistrarEmpresaActivity.this, "Formato del correo invalido", Toast.LENGTH_SHORT).show();
                    }
                    if (pssw.getText().toString().length() < 5) {
                        Toast.makeText(RegistrarEmpresaActivity.this, "La contraseña debe tener al menos 5 caracteres", Toast.LENGTH_SHORT).show();
                    }
                    if (nombre.getText().toString().equals("")) {
                        Toast.makeText(RegistrarEmpresaActivity.this, "El nombre no puede estar vacio", Toast.LENGTH_SHORT).show();
                    }
                    if (pssw.getText().toString().equals("")) {
                        Toast.makeText(RegistrarEmpresaActivity.this, "La contraseña no puede estar vacia", Toast.LENGTH_SHORT).show();
                    }
                    if (correo.getText().toString().equals("")) {
                        Toast.makeText(RegistrarEmpresaActivity.this, "El correo no puede estar vacio", Toast.LENGTH_SHORT).show();
                    }
